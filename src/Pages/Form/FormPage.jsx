...
import Sidebar from '../../Components/FormReusable/Sidebar';
import FieldContainer from '../../Components/FormReusable/FieldContainer';
...
const FormPage = ({ isNewForm }) => {
  ...
  const handleSaveOrUpdateForm = async () => {
    ...
    if (!hasBubblesOrInputs) {
      toast.error("Please add at least one bubble or input field.");
      return;
    }
    setLoading(true);
